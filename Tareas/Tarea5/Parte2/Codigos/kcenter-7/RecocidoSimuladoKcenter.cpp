...
Datas RecSim(){
    ...
    ifstream file("/Users/lloydna/Desktop/UP/5° Semestre/Optimizacion/PoderososC/kcenter-7.txt");
...
int main() {
    for(int i=0;i<50;i++){
        Datas result = RecSim();
        ofstream exporter;
        exporter.open("/Users/lloydna/Desktop/UP/5° Semestre/Optimizacion/PoderososC/kcenter7/kcenter-7r"+to_string(i)+".txt");
        ...
        system("say -v Paulina siguiente");
        cout << i+1;
    }
    ...
    Datas result = RecSim();
    ofstream exporter;
    exporter.open("/Users/lloydna/Desktop/UP/5° Semestre/Optimizacion/PoderososC/kcenter-7r.txt");
