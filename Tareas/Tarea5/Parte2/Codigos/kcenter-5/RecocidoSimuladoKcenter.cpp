...
Datas RecSim(){
    ...
    ifstream file("/Users/lloydna/Desktop/UP/5° Semestre/Optimizacion/PoderososC/kcenter-1");
...
int main() {
    for(int i=0;i<50;i++){
        Datas result = RecSim();
        ofstream exporter;
        exporter.open("/Users/lloydna/Desktop/UP/5° Semestre/Optimizacion/PoderososC/kcenter1/kcenter-1r"+to_string(i)+".txt");
    ...
    Datas result = RecSim();
    ofstream exporter;
    exporter.open("/Users/lloydna/Desktop/UP/5° Semestre/Optimizacion/PoderososC/kcenter-1r.txt");
