...
function graph(a)
    ...
    gif(anim, "/Users/lloydna/Desktop/UP/5° Semestre/Optimizacion/Optimizacion/Tareas/Tarea4/Parte1/Ejercicio5/GIFS/Gradiente.gif", fps = 15)
end
...
function Gradiente() #funciona para cualquier dimension modificando la cantidad de variables en la funcion
    X::Float64 = 3 #vector de valores iniciales (aleatorio)
