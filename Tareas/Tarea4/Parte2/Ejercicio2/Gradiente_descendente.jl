...
function graph()
    ...
    gif(anim, "/Users/lloydna/Desktop/UP/5° Semestre/Optimizacion/Optimizacion/Tareas/Tarea4/Parte2/Ejercicio2/GIFS/Gradiente.gif", fps = 60)
end

function Gradiente() #funciona para cualquier dimension modificando la cantidad de variables en la funcion
    X = [2.0,2.0] #vector de valores iniciales (aleatorio)
